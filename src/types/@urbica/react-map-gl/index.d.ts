...
import type { Map, FlyToOptions, EventData, MapMouseEvent, MapTouchEvent } from 'mapbox-gl';
import type GeoJSONFeature from 'mapbox-gl/src/util/vectortile_to_geojson';
import type LngLatBounds from 'mapbox-gl/src/geo/lng_lat_bounds';
import type { EventProps } from './eventProps';
import type MapboxMap from 'mapbox-gl/src/ui/map';

declare module '@urbica/react-map-gl' {
	export default class MapGL extends React.Component<MapGLProps, MapGLState> {
		getMap: () => Map;
	}

	export const MapContext: Context<MapboxMap> = createContext(null);

	export class Layer extends React.Component<P> {
		onHover?: (event: InteractionEvent) => void;
	}

	export class CustomLayer extends React.Component<ReactComponentProps, any> {}
	export class Source extends React.Component<ReactComponentProps, any> {}
	export class Popup extends React.Component<ReactComponentProps, any> {}

	export class Marker extends React.Component<MarkerProps, any> {}

	export class FeatureState extends React.Component<ReactComponentProps, any> {}
	export class Image extends React.Component<ReactComponentProps, any> {}
	export class AttributionControl extends React.Component<ReactComponentProps, any> {}
	export class FullscreenControl extends React.Component<ReactComponentProps, any> {}
	export class GeolocateControl extends React.Component<ReactComponentProps, any> {}
	export class NavigationControl extends React.Component<ReactComponentProps, any> {}
	export class ScaleControl extends React.Component<ReactComponentProps, any> {}
	export class LanguageControl extends React.Component<ReactComponentProps, any> {}
	export class TrafficControl extends React.Component<ReactComponentProps, any> {}
	export class Filter extends React.Component<ReactComponentProps, any> {}
}

export type InteractionEvent = MapMouseEvent & {
